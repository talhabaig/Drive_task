...
import { addFile, addFolder, selectFolders } from "@/app/features/counter/folderSlice";
...
console.log(foldername);
 ...
 item.name !== "Folder id"
    ...
    <div
      className="flex items-center gap-4 py-[20px] px-4 border-b justify-start text-[18px] w-full "
    >
      <div
        onClick={openModal}
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} heading="Create File" >
